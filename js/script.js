...
i18next.init(
    {
        ...
        resources: { // 웹페이지를 구성하는 텍스트들을 json 형태로 입력
            ko: {
                translation: {
                    introduce: "유아의 향수는 당신의 일상에 자연의 향기로 특별함을 더하여 매력적이고 복합적인 향기를 만드는 가상의 향수 회사 입니다.",

                    // 첫번째 향수
                    beatrice: "베아트리체",
                    beatriceNote: "마쉬멜로우 | 오렌지블로섬 | 토바코",
                    beatriceDesc: "베아트리체는 서로 다른 언어가 만나 새로운 의미로 확장되는 경험에서 영감을 얻었습니다. 오렌지 블로섬의 깨끗하고 정돈된 플로럴 향이 마시멜로와 만나 폭신한 솜사탕이 되고, 이와 대비되는 씁쓸하고 레더리한 토바코 노트가 어우러지며 서로 독립적으로 존재하던 상반된 두 가지 향이 서로를 휘감듯 자리하며 낯선 조화의 향을 경험하게 합니다.",

                    // 두번째 향수
                    bellatrix: "벨라트릭스",
                    bellatrixNote: "화이트 샴페인 | 다즐링 티 | 크리미한 머스크",
                    bellatrixDesc: "화이트 샴페인의 섬세한 거품과 달달한 과일향에 씁쓸한 다즐링 차 향이 풍성하고 조화롭게 어우러져 찻잔 속에서 추는 우아한 향의 춤의 향연을 선사합니다. 코 끝에서부터 전해지는 크리미한 머스크와 샌달우드가 부드러운 잔향을 오래도록 느끼게 해줍니다."

                }
            },
            en: {
                translation: {
                    introduce: "Youare Perfume is a virtual perfume company that creates attractive and complex scents by adding special natural scents to your daily life.",
                    ...
                    bellatrixDesc: "The delicate bubbles of white champagne elegantly dance with the sweet fruity aroma of bitter darjeeling tea richly and harmoniously creating a feast in a teacup. Prolong the soft reverberation trail of creamy musk and sandalwood from the tip of the nose."
                }
            }
        }
    },
...
function updateContent() { // i18nest.init에서 세팅한 텍스트들 html 태그에 대입
    ...
    document.getElementById("bellatrixNote").innerHTML = i18next.t("bellatrixNote");
    document.getElementById("bellatrixDesc").innerHTML = i18next.t("bellatrixDesc");
}
